...
import 'package:laundry_firebase/pages/newpages/body/JobsOnGoing/showOnGoingStatus.dart';
          ...
          StatefulBuilder(
            builder: (context, setState) {
              ...
              Future<void> moveUpCascade(int index) async {
                ...
                final messageAffected =
                    affectedIds.map((id) => '#$id').join(', ');
              ...
              return ReorderableListView(
                ...
                children: List.generate(jobs.length, (index) {
                  ...
                  final dontMove = {'washing', 'drying', 'folding'}
                      .contains(job.processStep);
                            ...
                            child: AnimatedContainer(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  visNameArea(
                                      jobRepo.getJobsModel()!, isSelected),
