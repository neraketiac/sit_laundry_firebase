...
DatabaseJobsOngoing _databaseJobsGoing = DatabaseJobsOngoing();

Widget readDataJobsOnGoing(bool visible, Color color) {
  return StreamBuilder<List<JobModel>>(
    stream: _databaseJobsGoing.streamAll(),
    builder: (context, snapshot) {
      ...
      FsUsageTracker.instance.track('readDataJobsOnGoing', jobs.length);
      ...
      StatefulBuilder(
        builder: (context, setState) {
          Future<void> moveJob(int oldIndex, int newIndex) async {
            ...
            // 🔥 FIRESTORE UPDATE
            await _databaseJobsGoing.swapOrInsert(
          ...
          Future<void> moveUpCascade(int index) async {
            ...
            for (int i = index; i >= 0; i--) {
              // debugPrint('i=$i');
              // debugPrint('jobs[i].jobId=${jobs[i].jobId} currentId=$currentId');
              if (jobs[i].jobId == currentId) {
                ...
                // debugPrint('jobs[i].processStep=${jobs[i].processStep}');
            ...
            // debugPrint('lockedItemReached=$lockedItemReached');
            ...
            _databaseJobsGoing.cascadeUp(affectedJobs);
          ...
          Future<void> moveDownCascade(int index) async {
            ...
            // 3️⃣ Firestore batch update (atomic)
            _databaseJobsGoing.cascade(affectedJobs);
          ...
          Future<bool> moveDownCascadeBool(
            ...
            _databaseJobsGoing.updateJobId(movingJob.docId, newIndexJobId);
          ...
          return ReorderableListView(
            ...
            onReorder: (oldIndex, newIndex) async {
              ...
              if (action == ReorderAction.swap) {
                ...
                // 🔥 Update Firestore
                await Future.wait([
                  _databaseJobsGoing.updateJobId(
