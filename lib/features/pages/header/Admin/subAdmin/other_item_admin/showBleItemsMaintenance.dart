...
import 'package:laundry_firebase/core/services/database_item_models/database_ble_items.dart';
import 'package:laundry_firebase/core/services/database_item_models/database_ble_items_hist.dart';
import 'package:laundry_firebase/features/items/models/otheritemmodel.dart';

class BleItemsPage extends StatefulWidget {
  const BleItemsPage({super.key});

  @override
  State<BleItemsPage> createState() => _BleItemsPageState();
}

class _BleItemsPageState extends State<BleItemsPage> {
  final service = BleItemsService();
  final histService = BleItemsServiceHist();
