...
import 'package:laundry_firebase/features/menus/menu_item.dart';
...
class _MyMenuMainState extends State<MyMenuMain> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: allAppBarX(context),
        drawer: buildMenuItems(context),
        body: _streamBuilder(0));
  }
      ...
      child: InkWell(
        onTap: () {
          ...
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => MyItemMenu(id, price)));
          setState(() {});
        },
        child: Ink.image(
